...
public class FixedLocationBatchActionCreateAndUpdateHelper extends FixedLocationBatchActionAbstractHelper
{

    public FixedLocationBatchActionCreateAndUpdateHelper( FixedLocationBatchActionDTO dto, FixedLocationService service )
    {
        super( dto, service );
        initRanges();
