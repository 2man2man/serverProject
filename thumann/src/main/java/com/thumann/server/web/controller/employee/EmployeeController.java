...
public class EmployeeController
{
    ...
    {
        EmployeeCreateDTO createDto = factory.createCreateDTO( json );
        ...
        Employee pupil = employeeService.createEmployee( createDto );
        EmployeeResponseDTO reponseDto = factory.createResponseDTO( pupil );
